...
class Cell {
	...
	public:
		...
		bool isLinked(int cand) { return mLinks & cand; };
		int getLinks() { return mLinks; };
		...
		bool isCandidate(int player, int cand) { return mCandidates[player] & cand; }
		...
		Tuple getNeighbor(int dir) { return mNeighbors[dir]; };
	    ...
	    bool isLinkedToBorder(int player, int border) { return mLinkedToBorder[player][border]; };
